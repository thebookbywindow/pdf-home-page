...
(function (global) {
  ...
  const TOOLS = {
    "compress-pdf": {
      ...
      subtitle: "WPS PDF compressor helps to reduce the PDF file size online without losing quality. Users can compress PDF files FREE in batch and customize compression settings to quickly and safely.",
      accept: PDF_ACCEPT,
      showRatio: true,
      lockFormats: false,
