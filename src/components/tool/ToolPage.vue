    ...
    <section :class="['tool-workspace-wrap', { 'tool-workspace-wrap--3d': officialShell }]">
      <div v-if="officialShell" class="tool-quota-bar" id="tool-quota-bar">
        <div class="tool-quota-bar__row">
          ...
          <div class="tool-quota-bar__end">
            <a class="tool-quota-wps-ai" href="https://www.wps.ai" target="_blank" rel="noopener noreferrer" title="https://www.wps.ai">
              <span class="tool-quota-wps-ai__boom" aria-hidden="true">
                <span class="tool-quota-wps-ai__ring"></span>
                <span class="tool-quota-wps-ai__ring tool-quota-wps-ai__ring--delay"></span>
                <img class="tool-quota-wps-ai__mark" :src="asset('images/legacy/wps-ai-logo-official.svg')" alt="" width="24" height="24">
              </span>
              <span class="tool-quota-wps-ai__label">More free uses</span>
            </a>
