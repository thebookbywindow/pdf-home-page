...
assert.match(i18n, /"Saved to WPS Cloud\. Download, then open Cloud Documents": "已儲存至 WPS Cloud。下載後開啟雲端文件"/);
...
assert.match(i18n, /source\.match\(\/\^WPS Office:/, "WPS Office quota must translate dynamic remaining-use text.");
